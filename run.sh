...
for r in saxpy gemm gemm_tiled gemm_i8 bmm linear_relu linear linear_gelu reduce softmax layernorm rmsnorm attention conv2d conv2d_mc maxpool transpose scan argmax vec4 clamp scale_half quant silu collatz sha256 raster; do
    echo
