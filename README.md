...
| `examples/*.clic` | Kernels: `saxpy`, `gemm`, `gemm_tiled`, `gemm_i8` (INT8), `linear_relu`, `reduce`, `scan`, `nn` (softmax/layernorm), `attention`, `conv2d`, `quant` (INT8), `collatz`, `sha256`, `raster` |
